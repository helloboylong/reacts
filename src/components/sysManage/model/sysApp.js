...
class SysApp extends Component {
    ...
    componentDidMount() {
        this.getAppData(this.state.status);
    }
    getAppData = (type) => {
    ...
    onChange = (e) => {
        ...
        this.getAppData(e.target.value)
    }
    isNew = () => {
    ...
    handleOkN = () => {
        ...
        axios.post(url + "/system-manage/create-sysAppConfig", params, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            }
        }).then((res) => {
    ...
    handleOk = () => {
        ...
        this.setState({ loading: true });
        axios.post(url + "/system-manage/update-sysAppConfig", params, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest'
            }
        }).then((res) => {
